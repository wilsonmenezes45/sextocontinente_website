  ...
  return (
    ...
    <div className="max-w-4xl mx-auto bg-white rounded-[2rem] shadow-xl shadow-slate-500/80 p-4 border border-slate-100 relative z-20 -mt-8">
        <div className="flex flex-wrap gap-2 mb-4 border-b border-slate-100 pb-3">
            <button className="flex items-center gap-2 bg-slate-900 text-white px-4 py-2 rounded-full text-xs font-semibold shadow-sm">
                <Calendar className="w-3.5 h-3.5" /> Marcação
            </button>
            <button className="flex items-center gap-2 text-slate-600 hover:bg-slate-100 px-4 py-2 rounded-full text-xs font-semibold transition">

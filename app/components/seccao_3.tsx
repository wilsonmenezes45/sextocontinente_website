  ...
  return (
    ...
    <section className="py-16 px-4 md:px-12 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                ...
                <button className="bg-slate-900 text-white px-5 py-2 rounded-full text-xs font-semibold">App</button>
                <button className="text-slate-600 hover:bg-slate-100 px-5 py-2 rounded-full text-xs font-semibold transition">Download</button>
                </div>
            </div>
            </div>
            </div>
